            ...
            public void onClick(View v) {
                ...
                if (money.getAskedAmount() >=amount){ // Amount is lower or equal
                    if (NetChecker.isNetworkAvailable(DonateMoneyActivity.this)){
                        ...
                        Transection transection = new Transection(binding.bkashTransectionNo.getText().toString(),amount,binding.name.getText().toString(),uniqueId,money.getUniqueID(),date);
